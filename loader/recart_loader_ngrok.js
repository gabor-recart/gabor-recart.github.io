; (function (document) {
  ...
  const regex = /.+recart_loader_ngrok.js/
  ...
  const params = new URLSearchParams(recartLoaderScript.substring(recartLoaderScript.lastIndexOf('?') + 1))
  ...
  const trackingJsUrlBase = 'https://gm-tracking-js-gabor.ngrok.io/loader.js'
